...
{
    public class goldenchest:PictureBox
    {
        public int boyut;
        ...
        public string name = "Golden Chest";
        public goldenchest(int x, int y, int oran, int boyut, Form2 form)
        {
            this.boyut = boyut;
            this.Image = Image.FromFile(@"goldenchest.png");
        ...
        public void addto_map()
        {
            ...
            chestPicturebox.Image = Image.FromFile(@"goldenchest.png");
