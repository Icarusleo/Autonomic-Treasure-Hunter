...
{
    public class silverchest:PictureBox
    {
        public int boyut;
        ...
        public string name = "Silver Chest";
        public silverchest(int x, int y, int oran, int boyut, Form2 form)
        {
            this.boyut = boyut;
            this.Image = Image.FromFile(@"silverchest.png");
        ...
        public void addto_map()
        {
            ...
            chestPicturebox.Image = Image.FromFile(@"silverchest.png");
