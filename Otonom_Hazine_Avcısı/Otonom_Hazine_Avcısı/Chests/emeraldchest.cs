...
{
    public class emeraldchest:PictureBox
    {
        public int boyut;
        ...
        public string name = "Emerald Chest";

        public emeraldchest(int x, int y, int oran, int boyut, Form2 form)
        {
            this.boyut = boyut;
            this.Image = Image.FromFile(@"emerald.png");
        ...
        public void addto_map()
        {
            ...
            chestPicturebox.Image = Image.FromFile(@"emerald.png");
